        ...
        <div id='projects' className="w-full  bg-white p-6">
            ...
            <div className="flex flex-wrap justify-center gap-7">
                <div className='mt-5  rounded-[12px] max-w-[300px] h-100 p-5 border-solid border-2 border-[#00df9a]'>
                    <a href="https://github.com/menezescosta/tasks-maneger-nextjs-typescript-nodejs-mysql" className='flex items-center gap-1 mb-5 relative right-[-130px] rounded-md p-2 w-[130px] text-1xl bg-[#00df9a]'><FaGithub/>open project</a>
                ...
                <div className='mt-5 rounded-[12px] max-w-[300px] h-100 p-5 border-solid border-2 border-[#00df9a] '>
                    <a href="https://github.com/menezescosta/projecto-restaurante" className='flex items-center gap-1 mb-5 relative right-[-130px] rounded-md p-2 w-[130px] text-1xl bg-[#00df9a]'><FaGithub/>open project</a>
                ...
                <div className='mt-5 rounded-[12px] max-w-[300px] h-100 p-5 border-solid border-2 border-[#00df9a] '>
                    <a href="https://github.com/menezescosta/menezescosta-projecto-awax-next.js-typescript" className='flex items-center mb-5 gap-1 relative right-[-130px] rounded-md p-2 w-[130px] text-1xl bg-[#00df9a]'><FaGithub/>open project</a>
                ...
                <div className='mt-5 rounded-[12px] max-w-[300px] h-100 p-5 border-solid border-2 border-[#00df9a] '>
                    <a href="" className='flex items-center gap-1 mb-5 relative right-[-130px] rounded-md p-2 w-[130px] text-1xl bg-[#00df9a]'><FaGithub/>open project</a>
                ...
                <div className='mt-5 rounded-[12px] max-w-[300px] h-100 p-5 border-solid border-2 border-[#00df9a] '>
                    <a href="https://github.com/menezescosta/Clima-js-API" className='flex items-center mb-5 gap-1 relative right-[-130px] rounded-md p-2 w-[130px] text-1xl bg-[#00df9a]'><FaGithub/>open project</a>
                ...
                <div className='mt-5 rounded-[12px] max-w-[300px] h-100 p-5 border-solid border-2 border-[#00df9a] '>
                    <a href="https://github.com/menezescosta/Calculadora-js" className='flex items-center mb-5 gap-1 relative right-[-130px] rounded-md p-2 w-[130px] text-1xl bg-[#00df9a]'><FaGithub/>open project</a>
                ...
                <div className='mt-5 rounded-[12px] max-w-[300px] h-100 p-5 border-solid border-2 border-[#00df9a] '>
                <a href="https://github.com/menezescosta/iAmHere-react-native" className='flex items-center gap-1 relative mb-5 right-[-130px] rounded-md p-2 w-[130px] text-1xl bg-[#00df9a]'><FaGithub/>open project</a>
