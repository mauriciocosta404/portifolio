    ...
    return(
        <div id='projects' className="w-full  bg-white p-6">
            ...
            <div className="flex flex-wrap justify-center gap-7">
                ...
                <div className='mt-5 rounded-[12px] max-w-[300px] h-100 p-5 border-solid border-2 border-[#00df9a] '>
                    <a href="https://github.com/menezescosta/Gestor-financeiro-react-js" className='flex items-center mb-5 gap-1 relative right-[-130px] rounded-md p-2 w-[130px] text-1xl bg-[#00df9a]'><FaGithub/>open project</a>
